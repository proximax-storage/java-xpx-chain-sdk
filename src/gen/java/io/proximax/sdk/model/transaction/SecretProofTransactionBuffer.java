...
public final class SecretProofTransactionBuffer extends Table {
  ...
  public static SecretProofTransactionBuffer getRootAsSecretProofTransactionBuffer(ByteBuffer _bb, SecretProofTransactionBuffer obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public int hashAlgorithm() { int o = __offset(18); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  public int secret(int j) { int o = __offset(20); return o != 0 ? bb.get(__vector(o) + j * 1) & 0xFF : 0; }
  ...
  public static void addHashAlgorithm(FlatBufferBuilder builder, int hashAlgorithm) { builder.addByte(7, (byte)hashAlgorithm, (byte)0); }
  ...
  public static void finishSecretProofTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedSecretProofTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
}
