 ...
 */
@ApiModel(description = "Transaction that creates or renew a namespace.")
...
public class RegisterNamespaceTransactionDTO {
  ...
  public RegisterNamespaceTransactionDTO signature(String signature) {
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO signer(String signer) {
    this.signer = signer;
    return this;
  }
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO version(Integer version) {
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO type(EntityTypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO maxFee(UInt64DTO maxFee) {
    this.maxFee = maxFee;
    return this;
  }
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO deadline(UInt64DTO deadline) {
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO namespaceType(NamespaceTypeEnum namespaceType) {
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO duration(UInt64DTO duration) {
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO namespaceId(UInt64DTO namespaceId) {
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public RegisterNamespaceTransactionDTO parentId(UInt64DTO parentId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RegisterNamespaceTransactionDTO registerNamespaceTransactionDTO = (RegisterNamespaceTransactionDTO) o;
    return Objects.equals(this.signature, registerNamespaceTransactionDTO.signature) &&
        Objects.equals(this.signer, registerNamespaceTransactionDTO.signer) &&
        Objects.equals(this.version, registerNamespaceTransactionDTO.version) &&
        Objects.equals(this.type, registerNamespaceTransactionDTO.type) &&
        Objects.equals(this.maxFee, registerNamespaceTransactionDTO.maxFee) &&
        Objects.equals(this.deadline, registerNamespaceTransactionDTO.deadline) &&
        Objects.equals(this.namespaceType, registerNamespaceTransactionDTO.namespaceType) &&
        Objects.equals(this.duration, registerNamespaceTransactionDTO.duration) &&
        Objects.equals(this.namespaceId, registerNamespaceTransactionDTO.namespaceId) &&
        Objects.equals(this.name, registerNamespaceTransactionDTO.name) &&
        Objects.equals(this.parentId, registerNamespaceTransactionDTO.parentId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(signature, signer, version, type, maxFee, deadline, namespaceType, duration, namespaceId, name, parentId);
  }
