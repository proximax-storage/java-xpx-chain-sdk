...
public class ModifyMultisigAccountTransactionDTO {
  ...
  public ModifyMultisigAccountTransactionDTO signature(String signature) {
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO signer(String signer) {
    this.signer = signer;
    return this;
  }
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO version(Integer version) {
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO type(EntityTypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO maxFee(UInt64DTO maxFee) {
    this.maxFee = maxFee;
    return this;
  }
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO deadline(UInt64DTO deadline) {
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO minRemovalDelta(Integer minRemovalDelta) {
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO minApprovalDelta(Integer minApprovalDelta) {
  ...
  **/
  ...
  public ModifyMultisigAccountTransactionDTO modifications(List<CosignatoryModificationDTO> modifications) {
    this.modifications = modifications;
    return this;
  }

  public ModifyMultisigAccountTransactionDTO addModificationsItem(CosignatoryModificationDTO modificationsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ModifyMultisigAccountTransactionDTO modifyMultisigAccountTransactionDTO = (ModifyMultisigAccountTransactionDTO) o;
    return Objects.equals(this.signature, modifyMultisigAccountTransactionDTO.signature) &&
        Objects.equals(this.signer, modifyMultisigAccountTransactionDTO.signer) &&
        Objects.equals(this.version, modifyMultisigAccountTransactionDTO.version) &&
        Objects.equals(this.type, modifyMultisigAccountTransactionDTO.type) &&
        Objects.equals(this.maxFee, modifyMultisigAccountTransactionDTO.maxFee) &&
        Objects.equals(this.deadline, modifyMultisigAccountTransactionDTO.deadline) &&
        Objects.equals(this.minRemovalDelta, modifyMultisigAccountTransactionDTO.minRemovalDelta) &&
        Objects.equals(this.minApprovalDelta, modifyMultisigAccountTransactionDTO.minApprovalDelta) &&
        Objects.equals(this.modifications, modifyMultisigAccountTransactionDTO.modifications);
  }

  @Override
  public int hashCode() {
    return Objects.hash(signature, signer, version, type, maxFee, deadline, minRemovalDelta, minApprovalDelta, modifications);
  }
