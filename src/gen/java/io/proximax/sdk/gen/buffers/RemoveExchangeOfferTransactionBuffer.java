...
public final class RemoveExchangeOfferTransactionBuffer extends Table {
  public static RemoveExchangeOfferTransactionBuffer getRootAsRemoveExchangeOfferTransactionBuffer(ByteBuffer _bb) { return getRootAsRemoveExchangeOfferTransactionBuffer(_bb, new RemoveExchangeOfferTransactionBuffer()); }
  public static RemoveExchangeOfferTransactionBuffer getRootAsRemoveExchangeOfferTransactionBuffer(ByteBuffer _bb, RemoveExchangeOfferTransactionBuffer obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; vtable_start = bb_pos - bb.getInt(bb_pos); vtable_size = bb.getShort(vtable_start); }
  public RemoveExchangeOfferTransactionBuffer __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public RemoveExchangeOfferBuffer offers(int j) { return offers(new RemoveExchangeOfferBuffer(), j); }
  public RemoveExchangeOfferBuffer offers(RemoveExchangeOfferBuffer obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int offersLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }

  public static int createRemoveExchangeOfferTransactionBuffer(FlatBufferBuilder builder,
      long size,
      int signatureOffset,
      int signerOffset,
      long version,
    ...
    RemoveExchangeOfferTransactionBuffer.addMaxFee(builder, maxFeeOffset);
    RemoveExchangeOfferTransactionBuffer.addVersion(builder, version);
    ...
    RemoveExchangeOfferTransactionBuffer.addSize(builder, size);
    RemoveExchangeOfferTransactionBuffer.addType(builder, type);
    RemoveExchangeOfferTransactionBuffer.addOffersCount(builder, offersCount);
    return RemoveExchangeOfferTransactionBuffer.endRemoveExchangeOfferTransactionBuffer(builder);
  }

  public static void startRemoveExchangeOfferTransactionBuffer(FlatBufferBuilder builder) { builder.startObject(9); }
  ...
  public static int endRemoveExchangeOfferTransactionBuffer(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishRemoveExchangeOfferTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedRemoveExchangeOfferTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
}
