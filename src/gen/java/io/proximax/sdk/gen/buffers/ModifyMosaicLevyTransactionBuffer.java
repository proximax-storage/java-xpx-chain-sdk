...
public final class ModifyMosaicLevyTransactionBuffer extends Table {
  ...
  public static ModifyMosaicLevyTransactionBuffer getRootAsModifyMosaicLevyTransactionBuffer(ByteBuffer _bb, ModifyMosaicLevyTransactionBuffer obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public MosaicLevyBuffer levy() { return levy(new MosaicLevyBuffer()); }
  public MosaicLevyBuffer levy(MosaicLevyBuffer obj) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }

  public static int createModifyMosaicLevyTransactionBuffer(FlatBufferBuilder builder,
      long size,
      int signatureOffset,
      int signerOffset,
      long version,
  ...
  public static void addLevy(FlatBufferBuilder builder, int levyOffset) { builder.addOffset(8, levyOffset, 0); }
  public static int endModifyMosaicLevyTransactionBuffer(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishModifyMosaicLevyTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedModifyMosaicLevyTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
}
