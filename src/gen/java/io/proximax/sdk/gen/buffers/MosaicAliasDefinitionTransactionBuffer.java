...
public final class MosaicAliasDefinitionTransactionBuffer extends Table {
  ...
  public int aliasAction() { int o = __offset(22); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  ...
  public static void addAliasAction(FlatBufferBuilder builder, int aliasAction) { builder.addByte(9, (byte)aliasAction, (byte)0); }
