...
public final class AddExchangeOfferTransactionBuffer extends Table {
  ...
  public static AddExchangeOfferTransactionBuffer getRootAsAddExchangeOfferTransactionBuffer(ByteBuffer _bb, AddExchangeOfferTransactionBuffer obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public AddExchangeOfferBuffer offers(int j) { return offers(new AddExchangeOfferBuffer(), j); }
  public AddExchangeOfferBuffer offers(AddExchangeOfferBuffer obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int offersLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }

  public static int createAddExchangeOfferTransactionBuffer(FlatBufferBuilder builder,
      long size,
      int signatureOffset,
      int signerOffset,
      long version,
  ...
  public static int endAddExchangeOfferTransactionBuffer(FlatBufferBuilder builder) {
