...
public final class MosaicSupplyChangeTransactionBuffer extends Table {
  public static MosaicSupplyChangeTransactionBuffer getRootAsMosaicSupplyChangeTransactionBuffer(ByteBuffer _bb) { return getRootAsMosaicSupplyChangeTransactionBuffer(_bb, new MosaicSupplyChangeTransactionBuffer()); }
  public static MosaicSupplyChangeTransactionBuffer getRootAsMosaicSupplyChangeTransactionBuffer(ByteBuffer _bb, MosaicSupplyChangeTransactionBuffer obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; vtable_start = bb_pos - bb.getInt(bb_pos); vtable_size = bb.getShort(vtable_start); }
  public MosaicSupplyChangeTransactionBuffer __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public int direction() { int o = __offset(20); return o != 0 ? bb.get(o + bb_pos) & 0xFF : 0; }
  public long delta(int j) { int o = __offset(22); return o != 0 ? (long)bb.getInt(__vector(o) + j * 4) & 0xFFFFFFFFL : 0; }
  public int deltaLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer deltaAsByteBuffer() { return __vector_as_bytebuffer(22, 4); }
  public ByteBuffer deltaInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 4); }
  ...
  public static void startMosaicSupplyChangeTransactionBuffer(FlatBufferBuilder builder) { builder.startObject(10); }
  ...
  public static void addDirection(FlatBufferBuilder builder, int direction) { builder.addByte(8, (byte)direction, (byte)0); }
  public static void addDelta(FlatBufferBuilder builder, int deltaOffset) { builder.addOffset(9, deltaOffset, 0); }
  public static int createDeltaVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addInt(data[i]); return builder.endVector(); }
  public static void startDeltaVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static int endMosaicSupplyChangeTransactionBuffer(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishMosaicSupplyChangeTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedMosaicSupplyChangeTransactionBufferBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
}
