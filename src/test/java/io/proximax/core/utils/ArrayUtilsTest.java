...
public class ArrayUtilsTest {
    ...
    public void duplicateThrowsExceptionOnNull() {
        // Act:
       assertThrows(NullPointerException.class, () -> ArrayUtils.duplicate(null));
    }
    ...
    public void splitFailsIfSplitIndexIsNegative() {
        ...
        // Act:
        assertThrows(IllegalArgumentException.class, () -> ArrayUtils.split(bytes, -1));
    }
    ...
    public void splitFailsIfSplitIndexIsGreaterThanInputLength() {
        ...
        // Act:
        assertThrows(IllegalArgumentException.class, () -> ArrayUtils.split(bytes, bytes.length + 1));
    }
