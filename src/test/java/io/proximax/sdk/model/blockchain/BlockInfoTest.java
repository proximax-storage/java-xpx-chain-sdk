...
class BlockInfoTest {
   ...
   void createANewBlockInforomDto() {
      ...
      metaDto.setNumTransactions(BigDecimal.valueOf(25));
      ...
      blockDto.setVersion(BigDecimal.valueOf(36867l));
      blockDto.setType(BigDecimal.ONE);
      ...
      /// do the assertions
       ...
       assertEquals(NetworkType.MIJIN_TEST, blockInfo.getNetworkType());
       assertEquals(3, blockInfo.getVersion());
       assertEquals(1, blockInfo.getType());
