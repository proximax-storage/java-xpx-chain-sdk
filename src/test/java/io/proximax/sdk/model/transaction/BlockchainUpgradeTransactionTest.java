 ...
 */
class BlockchainUpgradeTransactionTest {

   @Test
   void testConstructor() {
      BlockchainUpgradeTransaction trans = BlockchainUpgradeTransaction.create(BigInteger.ONE, new BlockchainVersion(1, 2, 3, 4), new FakeDeadline(), NetworkType.MIJIN);
